    ...
    <header className="h-16 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-8 shrink-0">
      <div className="flex items-center gap-3">
        <h2 className="font-bold text-slate-800 dark:text-slate-100">
          {activeView === 'feed' ? 'Mon Flux de Veille' : 'Assistant Intelligent'}
        </h2>
      ...
      <div className="flex items-center gap-4">
        <div className="relative">
          ...
          <input 
            className="pl-9 pr-4 py-1.5 bg-slate-100 dark:bg-slate-800 border-none rounded-lg text-sm w-64 focus:ring-2 focus:ring-blue-500/20 focus:outline-none dark:text-white" 
